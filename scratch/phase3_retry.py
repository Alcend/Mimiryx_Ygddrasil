...
# 2. Button (Let's check if Synthesize Stream button is there)
...
# 3. Split Editor
pattern = re.compile(r'\{\/\* Editor Body \*\/\}.*?\{\/\* Bottom Actions \*\/\}', re.DOTALL)

split_screen = """{/* Phase 3: Synaptic Dump Editor */}
...
text = pattern.sub(split_screen, text)
